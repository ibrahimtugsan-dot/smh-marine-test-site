const copy = {
  ...
  tr: {
    ...
    expertiseKicker: 'Uzmanlık alanları', expertiseTitle: 'İhtiyacınız olan hizmete doğrudan ulaşın.', expertiseIntro: 'Gemi onarımı, teknik inceleme, sörvey veya yeni inşa projesi planlayan teknik yöneticiler için ayrıntılı hizmet sayfaları.', expertiseRepair: 'Gemi Onarımı ve Havuzlama', expertiseEngine: 'Ana Makine ve Krankşaft İşleri', expertiseOwner: 'Armatör Temsilciliği', expertiseNewbuilding: 'Yeni İnşa Gözetimi', expertisePurchase: 'Satın Alma Öncesi İnceleme', expertiseSurvey: 'Özel Sörvey Hazırlığı', expertiseOpen: 'Hizmet ayrıntılarını inceleyin',
